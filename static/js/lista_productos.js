                ...
                const productoHTML = `
                    <div class="col-md-4">
                        <div class="card product-card h-100">
                            <img src="${safeUrl(producto.imagen)}" class="card-img-top product-img" alt="${escapeHtml(producto.nombre)}">
                            <div class="card-body product-card-body">
                                <h5 class="card-title">${escapeHtml(producto.nombre)}</h5>
                                <p class="card-text">$${producto.precio}</p>
                                <p class="card-text"><small class="text-muted">${escapeHtml(producto.categoria)}</small></p>
